...
const Home = () => {
  return (
    <article className="w-screen min-h-screen bg-[url('../src/assets/home/background-home-mobile.jpg')] sm:bg-[url('../src/assets/home/background-home-tablet.jpg')] md:bg-[url('../src/assets/home/background-home-desktop.jpg')] bg-origin-content bg-center bg-cover">

      <section className="page-content min-h-screen pt-40 pb-8 px-8 text-white">

        <section className='home p-2 min-h-screen flex flex-col items-center justify-around lg:flex-row lg:items-center lg:justify-around'>
