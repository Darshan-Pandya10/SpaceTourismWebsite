...
const Crew = () => {
  ...
  return (
     <main className="w-screen min-h-screen bg-[url('../src/assets/crew/background-crew-mobile.jpg')] sm:bg-[url('../src/assets/crew/background-crew-tablet.jpg')] md:bg-[url('../src/assets/crew/background-crew-desktop.jpg')] bg-cover">
        <div className="page-content min-h-screen pt-40 px-8 text-white ">
        ...
        <div className="crew  flex flex-col items-center justify-center my-12 sm:flex-col-reverse sm:items-center sm:justify-center lg:flex-row-reverse lg:items-center lg:justify-center">
         
          <img src={showImage} className='w-[20rem] lg:w-[30rem] mx-auto h-full object-contain' alt={`image of ${name}`} />
          ...
          <div className="crew-details py-4 flex flex-col items-center justify-center sm:w-[30rem] mb-12  text-center sm:flex-col sm:items-center sm:justify-center lg:mb-30">
            ...
            <p className='member-bio leading-7 tracking-wide text-base'>{bio}</p>
